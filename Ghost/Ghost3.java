...
public class Ghost3 extends AllGhost {
	...
	if (yPos != pMan.getY()) {
		...
		for (int LoR=0, i=2; LoR<12; LoR++) {
		    ...
		    // if you don't understand this code, read book page 11
	    ...
	    // and it falls in the same y-axis as the Pacman now
	    if (yPos == pMan.getY()) {
	...
	if (a_Map.whichMap() == 1) {
	    ...
	    fixedPosX = 40;
	    fixedPosY = 17;
	    x_stepToMaze = 3; //Ghost3 starts moving after pacman walked 3 steps
	    y_stepToMaze = 0;
	    x_block_FROM = 30;
	    x_block_TO = 50;
	    y_block_FROM = 11;
